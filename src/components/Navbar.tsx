          ...
          <Nav className="ms-auto" defaultActiveKey="#home">
            <Nav.Item>
              <Nav.Link as={Link} to="/" onClick={() => updateExpanded(false)}>
                <AiOutlineHome className="inline-block mb-0.5" /> Home
              </Nav.Link>
            </Nav.Item>
            ...
            <Nav.Item>
              ...
              >
                <AiOutlineUser className="inline-block mb-0.5" /> About
              </Nav.Link>
            </Nav.Item>
            ...
            <Nav.Item>
              <Nav.Link
                ...
                onClick={() => updateExpanded(false)}
              >
                <CgFileDocument className="inline-block mb-0.5" /> Resume
              </Nav.Link>
            </Nav.Item>
            ...
            <Nav.Item className="fork-btn">
              ...
              >
                ...
                <AiFillStar className="inline-block text-base" />
              </Button>
            </Nav.Item>
          </Nav>
        </Navbar.Collapse>
